...
//table
let tableAdaptiv__btn = document.querySelectorAll('.table-adaptiv__btn');
for (let i = 0; i < tableAdaptiv__btn.length; i++) {
  tableAdaptiv__btn[i].onclick = function () {
    this.classList.toggle('table-adaptiv__btn--active');
  }
};
